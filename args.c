...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --file=Directory  Executes all the line in the file except the ones that\n                          start with '#'.",
  "  -m, --max=INT         Max number of commands that can run before the program\n                          ends.",
  "  -s, --signalfile      Creates a file called 'signal.txt' that will contain\n                          all the signal we can use with the PID.",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* Executes all the line in the file except the ones that start with '#'..  */
          ...
          break;
        case 'm':	/* Max number of commands that can run before the program ends..  */
          ...
          break;
        case 's':	/* Creates a file called 'signal.txt' that will contain all the signal we can use with the PID..  */
